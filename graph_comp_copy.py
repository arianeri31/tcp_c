...
df_size = pd.read_csv("results_sizes_copy_comp.csv")
df_sends = pd.read_csv("results_sends_copy_comp.csv")
...
output_file = get_next_filename("copy_comp_size")
...
output_file = get_next_filename("copy_comp_sends")
plt.savefig(output_file, dpi=300, bbox_inches="tight")
print(f"Graph saved in {output_file}")
...
output_file = get_next_filename("copy_comp_msg_size")
plt.savefig(output_file, dpi=300, bbox_inches="tight")
print(f"Graph saved in {output_file}")
...
output_file = get_next_filename("copy_comp_msg_sends")
plt.savefig(output_file, dpi=300, bbox_inches="tight")
print(f"Graph saved in {output_file}")
